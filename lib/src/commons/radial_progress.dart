...
class RadialPrgress extends StatefulWidget {
  ...
  const RadialPrgress({Key key, this.goalCompleted = 0.7, this.progressColor = Colors.white, this.progressBackgroundColor = Colors.white, this.width = 8, @required this.child}) : super(key: key);

  @override
  _RadialPrgressState createState() => _RadialPrgressState();
}

class _RadialPrgressState extends State<RadialPrgress> with SingleTickerProviderStateMixin{
